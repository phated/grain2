...
## [0.6.0](https://github.com/phated/grain2/compare/grain-v0.5.13...grain-v0.6.0) (2023-03-22)


### ⚠ BREAKING CHANGES

* **stdlib:** Use Array length as default end in `Array.slice` function ([#1762](https://github.com/phated/grain2/issues/1762))
* **compiler:** Remove recursive_types and principal config ([#1751](https://github.com/phated/grain2/issues/1751))
...
* **compiler:** Remove built-in FileDescriptor type ([#1747](https://github.com/phated/grain2/issues/1747))
...
* **compiler:** Allocate closures only when necessary ([#1660](https://github.com/phated/grain2/issues/1660))
...
* **compiler:** Apply correct rules for parsing Unicode whitespace ([#1554](https://github.com/phated/grain2/issues/1554))
...
* **compiler:** Rename `_grainEnv` to `_genv` ([#1607](https://github.com/phated/grain2/issues/1607))
* **compiler:** Add `yield` and `macro` reserved keywords ([#1471](https://github.com/phated/grain2/issues/1471))
* **compiler:** Implement `Infinity` and `NaN` syntax ([#1472](https://github.com/phated/grain2/issues/1472))
* **stdlib:** `List.rotate` wraparound for count > length ([#1558](https://github.com/phated/grain2/issues/1558))
* **compiler:** Early return ([#1464](https://github.com/phated/grain2/issues/1464))
...
* **ci:** Add builds for preview binaries ([#1](https://github.com/phated/grain2/issues/1)) ([d9a5e70](https://github.com/phated/grain2/commit/d9a5e7033c5ba0a8909efa2a5c67093739123e12))
* **ci:** Refactor, reusable, and streamline ([e960f6f](https://github.com/phated/grain2/commit/e960f6fa0126fa802220fadfdd533644ba2e4029))
* **compiler:** Add `yield` and `macro` reserved keywords ([#1471](https://github.com/phated/grain2/issues/1471)) ([f0e29c5](https://github.com/phated/grain2/commit/f0e29c5e6d2fc3a4deb884816014fa4d90ee8f1b))
* **compiler:** Add ability to match on low level wasm types ([#1588](https://github.com/phated/grain2/issues/1588)) ([0d30888](https://github.com/phated/grain2/commit/0d3088846bcf865d8c3aa4298db9148b071664fc))
...
* **compiler:** Allocate closures only when necessary ([#1660](https://github.com/phated/grain2/issues/1660)) ([c40df12](https://github.com/phated/grain2/commit/c40df12b95f6f3a74bf89d637d60c64714b1d31e))
* **compiler:** Allow a newline character after 'as' when aliasing ([#1641](https://github.com/phated/grain2/issues/1641)) ([2719034](https://github.com/phated/grain2/commit/27190343160fe99957a9ca7169c48c0d673c81ef))
...
* **compiler:** Bytes literals ([#1662](https://github.com/phated/grain2/issues/1662)) ([3d8e4c5](https://github.com/phated/grain2/commit/3d8e4c5ee074e393eebeed82d2c4bd0590a0ad31))
...
* **compiler:** Early return ([#1464](https://github.com/phated/grain2/issues/1464)) ([1bffc82](https://github.com/phated/grain2/commit/1bffc821002e10c6fcbfb0fcf65750cda5c1e29f))
...
* **compiler:** Implement `Infinity` and `NaN` syntax ([#1472](https://github.com/phated/grain2/issues/1472)) ([74a196d](https://github.com/phated/grain2/commit/74a196d947dea8a31e3f80154f952903f1f8bb89))
...
* **compiler:** Propagate attribute locations to Anftree ([#1642](https://github.com/phated/grain2/issues/1642)) ([cce2821](https://github.com/phated/grain2/commit/cce2821e3b4bedbe8eef5a9814fed3eb24d7eccd))
...
* **compiler:** Suppress warnings about using fromNumber for Int32/64 and Float32/64 tests ([#1638](https://github.com/phated/grain2/issues/1638)) ([b687e31](https://github.com/phated/grain2/commit/b687e31d6e5d82260cb31f355253934da407d3c5))
...
* **graindoc:** Refactored Graindoc parser ([#1658](https://github.com/phated/grain2/issues/1658)) ([b447ced](https://github.com/phated/grain2/commit/b447cedc648ece5c5c892ff66172d2f264831647))
...
* **grainlsp:** Provide hovers on use statements ([#1688](https://github.com/phated/grain2/issues/1688)) ([c5cd21f](https://github.com/phated/grain2/commit/c5cd21fc3a6b703bb9de2c7a4c7834bd27a743a9))
...
* **ci:** Need to rename the binaries to upload correctly ([7d7a684](https://github.com/phated/grain2/commit/7d7a6849098bc06136af1c756ad5d870dd6ac924))
* **compiler:** Allow early return in let bindings ([#1727](https://github.com/phated/grain2/issues/1727)) ([43adefe](https://github.com/phated/grain2/commit/43adefe7ff7e4ca7ba6f6f80889f66b557451888))
* **compiler:** Apply correct rules for parsing Unicode whitespace ([#1554](https://github.com/phated/grain2/issues/1554)) ([4f19d71](https://github.com/phated/grain2/commit/4f19d71b6bbe7f2094fadbb9fbd99f1fd62e80ae))
* **compiler:** Correct locations for data constructor idents ([#1752](https://github.com/phated/grain2/issues/1752)) ([d015a97](https://github.com/phated/grain2/commit/d015a978d7969994d09b7050f9f358fc5bba9d23))
* **compiler:** Correct the warning suggestion for Float32 And Float64 values ([#1671](https://github.com/phated/grain2/issues/1671)) ([32e0397](https://github.com/phated/grain2/commit/32e03972660b451ad6f068281aee08ad0d958c27))
...
* **compiler:** Fix memory bug in universal exports ([#1663](https://github.com/phated/grain2/issues/1663)) ([87724f0](https://github.com/phated/grain2/commit/87724f0a2c1e0697a138ebb3f2ba98a337be88f5))
* **compiler:** Inline record exception constructors ([#1709](https://github.com/phated/grain2/issues/1709)) ([ffd4d44](https://github.com/phated/grain2/commit/ffd4d44d0d341f9c835d24cbebe0ac4e317fe93b))
* **compiler:** Properly handle parsing return of negative number ([#1611](https://github.com/phated/grain2/issues/1611)) ([0a5a97c](https://github.com/phated/grain2/commit/0a5a97c8fb7cfd3f6ac068fb343e66457381fc13))
* **compiler:** Provide appropriate error for empty char literals ([#1728](https://github.com/phated/grain2/issues/1728)) ([e4dcda8](https://github.com/phated/grain2/commit/e4dcda8615b0c611ec201ac5f315e99b3ba1bfb3))
* **compiler:** Provide full module interface in intermediate wasm files ([#1756](https://github.com/phated/grain2/issues/1756)) ([683f803](https://github.com/phated/grain2/commit/683f803885e1ea073b7693dc1446b379fc49d311))
* **compiler:** Remove number constant folding optimization ([#1676](https://github.com/phated/grain2/issues/1676)) ([181798d](https://github.com/phated/grain2/commit/181798db69e708c69ca08a24785de7c03b9c45ab))
* **compiler:** Support deeply nested types in modules ([#1673](https://github.com/phated/grain2/issues/1673)) ([b6651bb](https://github.com/phated/grain2/commit/b6651bbc589810dcea123920d9257d339307ed3d))
...
* **graindoc:** Escape * characters that would close markdown bold incorrectly ([3b6b5ca](https://github.com/phated/grain2/commit/3b6b5ca74e3b40a41206ba5f3d527166ea267ada))
* **graindoc:** Escape * chars that would close markdown bold incorrectly ([#1685](https://github.com/phated/grain2/issues/1685)) ([3b6b5ca](https://github.com/phated/grain2/commit/3b6b5ca74e3b40a41206ba5f3d527166ea267ada))
* **graindoc:** Use Markdown bold helper for each case of bolding ([#1695](https://github.com/phated/grain2/issues/1695)) ([d798433](https://github.com/phated/grain2/commit/d798433fbb99eace2f100c0cd94c78eb99b0cf93))
...
* **compiler:** Remove built-in FileDescriptor type ([#1747](https://github.com/phated/grain2/issues/1747)) ([d40e84a](https://github.com/phated/grain2/commit/d40e84a74479dfb2676005e8496369d36e4eaaba))
* **compiler:** Remove recursive_types and principal config ([#1751](https://github.com/phated/grain2/issues/1751)) ([534bdca](https://github.com/phated/grain2/commit/534bdcafe463128eca499c558459a9882478fb2a))
* **compiler:** Rename `_grainEnv` to `_genv` ([#1607](https://github.com/phated/grain2/issues/1607)) ([73c9499](https://github.com/phated/grain2/commit/73c94997c7bd08324398ea87498d2b498c5bf658))
